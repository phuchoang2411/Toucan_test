...
const en = {
  ...
  date_mismatch_required: 'This visit is being completed on a different day than scheduled — please explain why (BR7).',
  ...
  different_day_warning: '⚠ This is being completed on a different day than scheduled ({date}) — why?',
...
const vi: Record<StrKey, string> = {
  ...
  date_mismatch_required: 'Lượt ghé thăm này đang được hoàn thành vào ngày khác với lịch — vui lòng giải thích lý do (BR7).',
  ...
  different_day_warning: '⚠ Đang hoàn thành vào ngày khác với lịch đã đặt ({date}) — vì sao?',
