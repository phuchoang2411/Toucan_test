...
const en = {
  ...
  no_schedule_history_yet: 'No visits scheduled yet.',

  // ── Schedule page ──
  working_schedule_title: 'Working Schedule',
  add_schedule_button: 'Add schedule',
  add_schedule_title: 'New schedule',
  outlet_select_label: 'Outlet *',
  select_outlet_placeholder: 'Select an outlet…',
  schedule_saved: 'Schedule saved',
  failed_to_save_schedule: 'Failed to save schedule',
  save_schedule: 'Save schedule',
  close_dialog_aria: 'Close dialog',
  ...
  no_visits_yet: 'No visits scheduled yet. Add one here or from the outlet form.',
  ...
  current_stage_warning: '⚠ This is the outlet\'s current stage — recorded as a held stage, not a transition.',
...
const vi: Record<StrKey, string> = {
  ...
  outlet_required: 'Điểm bán là bắt buộc',
  ...
  schedule_history_title: 'Lịch sử ghé thăm',
  no_schedule_history_yet: 'Chưa có lượt ghé thăm nào được lên lịch.',

  // ── Schedule page ──
  working_schedule_title: 'Lịch làm việc',
  add_schedule_button: 'Thêm lịch ghé thăm',
  add_schedule_title: 'Lịch ghé thăm mới',
  outlet_select_label: 'Điểm bán *',
  select_outlet_placeholder: 'Chọn một điểm bán…',
  schedule_saved: 'Đã lưu lịch ghé thăm',
  failed_to_save_schedule: 'Lưu lịch ghé thăm thất bại',
  save_schedule: 'Lưu lịch ghé thăm',
  close_dialog_aria: 'Đóng hộp thoại',
  ...
  no_visits_yet: 'Chưa có lượt ghé thăm nào được lên lịch. Thêm tại đây hoặc từ biểu mẫu điểm bán.',
  ...
  current_stage_warning: '⚠ Đây là giai đoạn hiện tại của điểm bán — sẽ được ghi nhận là giữ nguyên giai đoạn, không phải chuyển đổi.',
